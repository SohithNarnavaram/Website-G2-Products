...
export const PortfolioSection = () => {
  return (
    <section id="portfolio" className="py-12 sm:py-16 md:py-20 lg:py-24 bg-background">
          ...
          {creators.map((creator, index) => (
            ...
            >
              ...
              <div className="p-4 sm:p-5">
                ...
                <p className="text-primary text-xs sm:text-sm font-medium mb-1">{creator.handle}</p>
                <p className="text-muted-foreground text-xs sm:text-sm">{creator.type}</p>
              </div>
            </motion.div>
          ))}
        </div>
